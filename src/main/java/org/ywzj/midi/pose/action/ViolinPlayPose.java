...
public class ViolinPlayPose extends ViolPlayPose {

    private long lastTimeStamp = 0;

    public ViolinPlayPose(LivingEntity player) {
        super(player);
    }
    ...
    public void getPullPushPoses() {
        for (float rot = -0.8f; rot <= -0.3f; rot += 0.025) {
            ...
            pullPushPoses.add(new PoseManager.PlayPose(null,null,null,-1.2f,null,-0.8f,(float) (-4f - bias * 2),null,(float) (-1.5f + bias * 2),(float) (-1.75f + bias * 0.25),rot,0f));
        }
    }
