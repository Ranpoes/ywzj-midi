...
import org.ywzj.midi.instrument.receiver.TubaMidiReceiver;

public class Tuba extends Instrument {

    public Tuba(String name, boolean loop, boolean portable, String keyStart, String keyEnd) {
        super(name, loop, portable, keyStart, keyEnd);
    }

    @Override
    public MidiReceiver receiver(LivingEntity player, Vec3 pos) {
        return new TubaMidiReceiver(this, player, pos);
    }
