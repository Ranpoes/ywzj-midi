...
import org.ywzj.midi.instrument.receiver.DoubleBassMidiReceiver;
import org.ywzj.midi.instrument.receiver.MidiReceiver;

public class DoubleBass extends Instrument {

    public DoubleBass(String name, boolean loop, boolean portable, String keyStart, String keyEnd) {
        super(name, loop, portable, keyStart, keyEnd);
    }

    @Override
    public MidiReceiver receiver(LivingEntity player, Vec3 pos) {
        return new DoubleBassMidiReceiver(this, player, pos);
    }
