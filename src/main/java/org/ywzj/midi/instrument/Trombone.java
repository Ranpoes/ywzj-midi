...
import org.ywzj.midi.instrument.receiver.TromboneMidiReceiver;

public class Trombone extends Instrument {

    public Trombone(String name, boolean loop, boolean portable, String keyStart, String keyEnd) {
        super(name, loop, portable, keyStart, keyEnd);
    }

    @Override
    public MidiReceiver receiver(LivingEntity player, Vec3 pos) {
        return new TromboneMidiReceiver(this, player, pos);
    }
