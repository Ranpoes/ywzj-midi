...
import org.ywzj.midi.instrument.receiver.OboeMidiReceiver;

public class Oboe extends Instrument {

    public Oboe(String name, boolean loop, boolean portable, String keyStart, String keyEnd) {
        super(name, loop, portable, keyStart, keyEnd);
    }

    @Override
    public MidiReceiver receiver(LivingEntity player, Vec3 pos) {
        return new OboeMidiReceiver(this, player, pos);
    }
